...
create table sys_role (
  ...
  menu_check_strictly  smallint        default 1,   -- 原 tinyint
  dept_check_strictly  smallint        default 1,   -- 原 tinyint
  status               char(1)         not null,
  del_flag             char(1)         default '0',
  create_by            varchar(64)     default '',
  create_time          TIMESTAMP,
...
create table sys_notice (
  ...
  notice_content    TEXT            default null,   -- 原 longblob 改为 TEXT
  status            char(1)         default '0',
  create_by         varchar(64)     default '',
  create_time       TIMESTAMP,
  update_by         varchar(64)     default '',
...
-- 注意：sys_user 表中没有 post_id, post_code, post_name, post_sort 字段，以下注释已移除
...
-- 注意：sys_role_dept 表中无 user_id 和 post_id，已移除
